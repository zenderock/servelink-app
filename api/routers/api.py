...
from dependencies import get_deployment_by_id, get_db, get_project_by_id, get_redis_client, templates

router = APIRouter()

STREAM_TTL = 900

@router.get("/api/deployments/{deployment_id}/events", name="api_deployment_events")
...
@router.get("/api/projects/{project_id}/events", name="api_project_events")
