...
Revision ID: db72f667cd70
Revises: 
Create Date: 2025-05-27 11:49:50.497608
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('installation_id', name=op.f('pk_github_installation'))
    )
    ...
    sa.ForeignKeyConstraint(['github_installation_id'], ['github_installation.installation_id'], name=op.f('fk_project_github_installation_id_github_installation')),
    ...
    sa.ForeignKeyConstraint(['project_id'], ['project.id'], name=op.f('fk_deployment_project_id_project')),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['deployment_id'], ['deployment.id'], name=op.f('fk_alias_deployment_id_deployment')),
    sa.ForeignKeyConstraint(['previous_deployment_id'], ['deployment.id'], name=op.f('fk_alias_previous_deployment_id_deployment')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_alias')),
    sa.UniqueConstraint('subdomain', name=op.f('uq_alias_subdomain'))
    )
