...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_deployment_creation_at"), "deployment", ["created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("branch", "environment", name="alias_type"), nullable=False
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_deployment_creation_at"), table_name="deployment")
