...
def upgrade() -> None:
    ...
    op.create_table('payment',
        ...
        sa.Column('payment_method', postgresql.ENUM('mobile_money', 'credit_card', name='payment_method', create_type=False), nullable=False),
        sa.Column('status', postgresql.ENUM('pending', 'processing', 'completed', 'failed', 'cancelled', name='payment_status', create_type=False), nullable=False, server_default='pending'),
